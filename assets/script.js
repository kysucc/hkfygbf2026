    ...
    headers: {
        'Content-Type': 'application/json'
                ...
                data.forEach(item => {
                    ...
                    // Assuming your spreadsheet headers are "Name", "Role", and "Location"
                    card.innerHTML = `
                ...
                document.getElementById('output').innerHTML = "<p>Failed to load data. Check console for details.</p>";
            }
        }
